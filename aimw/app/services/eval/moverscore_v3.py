# based on https://github.com/AIPHES/emnlp19-moverscore/blob/master/moverscore_v2.py
# to fix the issue of max_length and better model usage flexibility
...
def collate_idf(arr, tokenize, numericalize, idf_dict, pad="[PAD]", device="cuda:0"):
...
def get_bert_embedding(
    all_sens, model, tokenizer, idf_dict, batch_size=-1, device="cuda:0"
):
